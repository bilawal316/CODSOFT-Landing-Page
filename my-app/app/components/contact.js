              ...
              <div className="flex flex-col md:flex-row justify-between">
                <div className="my-2 md:my-auto mx-2 md:w-1/2">
                  ...
                  <input
                    ...
                    required
                    className="text-black mt-1 p-2 focus:ring-cyan-500 focus:border-cyan-500 block w-full shadow-sm sm:text-sm border-cyan-300 rounded-sm"
                  />
                </div>
                ...
                <div className="my-2 md:my-auto mx-2 md:w-1/2">
                  ...
                  <input
                    ...
                    required
                    className="text-black mt-1 p-2 focus:ring-turbo-yellow-500 focus:border-turbo-yellow-500 block w-full shadow-sm sm:text-sm border-turbo-yellow-300 rounded-sm"
                  />
                </div>
              </div>
              ...
              <div className="mt-8 mx-2 w-full">
                ...
                <div className="mt-1 mx-auto">
                  <textarea
                    ...
                    name="Message"
                    rows={6}
                    className="text-black shadow-sm w-full mt-1 p-2 block sm:text-sm rounded-sm"
